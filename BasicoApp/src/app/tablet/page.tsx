...
export default function TabletDashboard() {
    ...
    const [profesional, setProfesional] = useState<{ id: string, nombre: string, estacion_id: number, horario_laboral?: any } | null>(null)
            ...
            <header className="bg-surface/50 backdrop-blur-xl border-b border-slate-700/50 px-6 py-4">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl font-bold">{profesional?.nombre || 'Cargando...'}</h1>
